...
namespace Fungus
{
	...
	public class InvokeMethod : Command
	{
	    ...
	    public InvokeMethodParameter targetObject;
	    ...
	    protected virtual void Awake()
	    {
			...
			{
				objComponent = GetGameObject().GetComponent(componentType);
			}
        ...
        public GameObject GetGameObject()
        {
            ...
            if(!string.IsNullOrEmpty(targetObject.variableKey))
            {
                var variable = GetFlowchart().GetVariable<GameObjectVariable>(targetObject.variableKey);
            ...
            else if(targetObject.objValue != null)
            {
                return targetObject.objValue.gameObjectValue;
            }
            else
            {
                return null;
	    ...
	    public override void OnEnter()
	    {
			try
			{
				if (GetGameObject() == null || string.IsNullOrEmpty(targetComponentAssemblyName) || string.IsNullOrEmpty(targetMethod))
				{
					Continue();
					return;
				}
	    ...
	    public override string GetSummary()
	    {
	        ...
	        return GetGameObject().name + "." + targetComponentText + "." + targetMethodText;
	    }
